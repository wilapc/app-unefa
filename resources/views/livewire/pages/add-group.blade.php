<x-mary-form wire:submit="save">
  ...
  <x-mary-alert title="Cuidado!" description="Materia registrada." icon="o-exclamation-triangle" x-show="$wire.alert1" class="alert-warning" />
  ...
  for($i = 1; $i < 9; $i++){
    ...
    <x-slot:actions>
      <x-mary-button label="Agregar" class="bg-sky-600" type="submit" spinner="save" />
    </x-slot:actions>
</x-mary-form>